...
- (CATransform3D)corousel:(iCarousel *)carousel itemTransformForOffset:(CGFloat)offset baseTransform:(CATransform3D)transform
{
    ...
    const CGFloat spacing = [self carousel:carousel valueForOption:iCarouselOptionSpacing withDefault:1.15];
...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeLinear:
        {
            ...
            {
                return [self corousel:self itemTransformForOffset:offset baseTransform:transform];
